...
@Component({
  selector: 'app-exibicoes-externas',
  templateUrl: './exibicoes-externas.component.html',
  styleUrls: ['./exibicoes-externas.component.scss'],
})
export class ExibicoesExternasComponent {
